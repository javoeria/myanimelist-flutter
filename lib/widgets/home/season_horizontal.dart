      ...
      children: <Widget>[
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              Text('$kSeasonName ${season.first.year} Anime', style: Theme.of(context).textTheme.titleMedium),
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SeasonalAnimeScreen(year: season.first.year!, season: kSeasonName),
