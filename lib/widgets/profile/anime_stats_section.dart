      ...
      children: <Widget>[
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Text('Anime Stats', style: Theme.of(context).textTheme.subhead),
              SizedBox(height: 8.0),
              Row(
                ...
                children: <Widget>[
                  RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(text: stats.daysWatched.toString(), style: Theme.of(context).textTheme.body2),
                      ],
                    ),
                  ),
                  RichText(
            ...
            children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 8.0),
                      Text('Plan to Watch: ${stats.planToWatch}'),
                    ],
                  ),
                ],
              ),
              Column(
                ...
                children: <Widget>[
                  ...
                  Text('Rewatched: ${stats.rewatched}'),
                  SizedBox(height: 16.0),
                  Text('Episodes: ${stats.episodesWatched}'),
                ],
              ),
            ],
          ),
